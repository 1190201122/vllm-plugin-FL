...
if(NOT DEFINED OPS_SRC_DIR)
    set(OPS_SRC_DIR ${CMAKE_CURRENT_SOURCE_DIR})
endif()
if(NOT DEFINED OPS_ADV_DIR)
    get_filename_component(OPS_ADV_DIR "${CMAKE_CURRENT_SOURCE_DIR}" REALPATH)
else()
    get_filename_component(OPS_ADV_DIR "${OPS_ADV_DIR}" REALPATH)
endif()
get_filename_component(OPS_ADV_CMAKE_DIR            "${OPS_SRC_DIR}/cmake"                  REALPATH)
get_filename_component(OPS_ADV_UTILS_KERNEL_INC     "${OPS_SRC_DIR}/utils/inc/kernel"   REALPATH)
...
if(EXISTS ${ASCEND_CMAKE_DIR}/cmake/util/ascendc_impl_build.py)
    set(ASCENDC_CMAKE_UTIL_DIR ${ASCEND_CMAKE_DIR}/cmake/util)
endif()
...
if (BUILD_OPEN_PROJECT)
    if (NOT PREPARE_BUILD AND ENABLE_OPS_KERNEL)
        ...
        execute_process(COMMAND bash ${OPS_ADV_CMAKE_DIR}/scripts/prepare.sh
                -s ${OPS_ADV_DIR}
