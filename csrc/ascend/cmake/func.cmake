...
function(op_add_subdirectory OP_LIST OP_DIR_LIST)
    ...
    file(GLOB OP_HOST_CMAKE_FILES "${OPS_SRC_DIR}/**/op_host/CMakeLists.txt")
    ...
    foreach(op_name ${DEP_OP_LIST})
        if (DEFINED ${op_name}_depends)
            foreach(depend_info ${${op_name}_depends})
                if (NOT EXISTS ${OPS_SRC_DIR}/${depend_info}/op_host/CMakeLists.txt)
                    continue()
                endif ()
                ...
                if (NOT ${_depend_op_name} IN_LIST DEP_OP_LIST)
                    list(APPEND _OP_DEPEND_DIR_LIST ${OPS_SRC_DIR}/${depend_info})
                endif ()
            endforeach()
        endif()
    endforeach()
